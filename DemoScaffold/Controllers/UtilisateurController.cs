...
namespace DemoScaffold.Controllers
{
    public class UtilisateurController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Prenom,MotDePasse,Age")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Prenom,MotDePasse,Age")] Utilisateur utilisateur)
        {
            if (ModelState.IsValid)
            {
